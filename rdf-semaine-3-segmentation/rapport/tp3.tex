...
h <- hist (as.vector (o), breaks = seq (0, 1, 1 / nbins))\end{lstlisting}
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|}
      ...
      \hline
      \shortstack{\includegraphics[width=3cm]{texture-0/texture-0.png} \\ \tiny{rdf-2-classes-texture-0.png}} & \includegraphics[width=3cm]{texture-0/texture-0-5-ecart-type.png} & \includegraphics[width=3cm]{texture-0/texture-0-6-h2d.png} & ?\\
      \hline
      \shortstack{\includegraphics[width=3cm]{texture-1/texture-1.png} \\ \tiny{rdf-2-classes-texture-1.png}} & \includegraphics[width=3cm]{texture-1/texture-1-5-ecart-type.png} & \includegraphics[width=3cm]{texture-1/texture-1-6-h2d.png} & ?\\
      \hline
      \shortstack{\includegraphics[width=3cm]{texture-2/texture-2.png} \\ \tiny{rdf-2-classes-texture-2.png}} & \includegraphics[width=3cm]{texture-2/texture-2-5-ecart-type.png} & \includegraphics[width=3cm]{texture-2/texture-2-6-h2d.png} & ?\\
      \hline
      \shortstack{\includegraphics[width=3cm]{texture-3/texture-3.png} \\ \tiny{rdf-2-classes-texture-3.png}} & \includegraphics[width=3cm]{texture-3/texture-3-5-ecart-type.png} & \includegraphics[width=3cm]{texture-3/texture-3-6-h2d.png} & ?\\
      \hline
